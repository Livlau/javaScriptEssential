...
// display the details of employees who have specialization in JavaScript
function findEmployeeBySpecialization(employeeSpecialization) {
    ...
    if (foundEmployee) {
    document.getElementById('employeesDetails').innerHTML =`<p>${foundEmployee.id}: ${foundEmployee.name}: ${foundEmployee.age} - ${foundEmployee.department} - ${foundEmployee.specialization}</p>`;
    }
    else{
